module github.com/AvaLido/contracts/network
...
require (
	...
	github.com/ava-labs/avalanche-network-runner v1.0.10 // indirect
	github.com/ava-labs/avalanchego v1.7.9 // indirect
